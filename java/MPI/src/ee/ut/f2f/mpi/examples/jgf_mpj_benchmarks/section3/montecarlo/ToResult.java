...
/**
 * Class for defining the results of a task. Currently, this is simply the Monte Carlo generate rate path.
 * 
 * @author H W Yau
 */
public class ToResult implements java.io.Serializable {
	 ...
	 *            the value to set for the instance variable <code>finalStockPrice</code>.
	 */
