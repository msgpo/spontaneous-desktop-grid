...
public class Vec implements java.io.Serializable {
	...
	/**
	 * Substracts two vects and places the results in the current vector Used for speedup with local variables -there were too much Vec to be gc'ed Consumes about 10 units, whether sub consumes nearly
	 * 999 units!! cf thinking in java p. 831,832
	 */
