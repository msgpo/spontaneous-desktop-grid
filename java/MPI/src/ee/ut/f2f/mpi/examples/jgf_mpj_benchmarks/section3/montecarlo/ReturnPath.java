...
public class ReturnPath extends PathId {
	...
	/**
	 * Flag for indicating one of the return definitions, via: u_i = \ln{\frac{S_i}{S_{i-1}}} corresponding to the instantaneous compounded return.
	 */
	public static int COMPOUNDED = 1;

	/**
	 * Flag for indicating one of the return definitions, via: u_i = \frac{S_i - S_{i-1}}{S_i} corresponding to the instantaneous non-compounded return.
	 */
	...
	/**
	 * Value for the volatility-squared, a more natural quantity to use for many of the calculations.
	 */
	 ...
	 * 
	 * @param pathValue
	 *            for creating a return path with a precomputed path value. Indexed from 1 to <code>nPathArray-1</code>.
	 * @param nPathValue
	 ...
	 * @exception DemoException
	 *                thrown if instance variable <code>nPathValue</code> is undefined.
	 */
	 ...
	 * @exception DemoException
	 *                thrown if instance variable <code>returnDefinition</code> is undefined.
	 */
	 ...
	 * 
	 * @param returnDefinition
	 *            the value to set for the instance variable <code>returnDefinition</code>.
	 */
	 ...
	 * @exception DemoException
	 *                thrown if instance variable <code>expectedReturnRate</code> is undefined.
	 */
	 ...
	 *            the value to set for the instance variable <code>expectedReturnRate</code>.
	 */
	 ...
	 * @exception DemoException
	 *                thrown if instance variable <code>volatility</code> is undefined.
	 */
	 ...
	 * @exception DemoException
	 *                thrown if instance variable <code>volatility2</code> is undefined.
	 */
	 ...
	 * 
	 * @param volatility2
	 *            the value to set for the instance variable <code>volatility2</code>.
	 */
	 ...
	 * @exception DemoException
	 *                thrown if instance variable <code>variance</code> is undefined.
	 */
	...
	// ------------------------------------------------------------------------
	/**
	 * Method to calculate the expected return rate from the return data, using the relationship: \mu = \frac{\bar{u}}{\Delta t} + \frac{\sigma^2}{2}
	 * 
	 * @exception DemoException
	...
	/**
	 * Method to calculate <code>volatility</code> and <code>volatility2</code> from the return path data, using the relationship, based on the precomputed <code>variance</code>. \sigma^2 =
	 * s^2\Delta t
	 * 
	 * @exception DemoException
	 *                thrown if one of the quantites in the computation are undefined.
	 */
	 ...
	 * 
	 * @exception DemoException
	 *                thrown if the <code>mean</code> or <code>nPathValue</code> values are undefined.
	 */
