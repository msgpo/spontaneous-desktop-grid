...
/**
 * Class to do the work in the Application demonstrator, in particular the pricing of the stock path generated by Monte Carlo. The run method will generate a single sequence with the required
...
public class PriceStock extends Universal {
	...
	// ------------------------------------------------------------------------
	/**
	 * Method which is passed in the initialisation data common to all tasks, and then unpacks them for use by this object.
	 * 
	 * @param obj
	...
	/**
	 * Method which is passed in the data representing each task, which then unpacks it for use by this object.
	 * 
	 * @param obj
	...
	public ToResult getResult() {
		...
		return new ToResult(resultHeader, expectedReturnRate, volatility, volatility2, finalStockPrice, pathValue);
	}
}
