...
public final class Utilities {
	...
	/**
	 * Static method which behaves like the Unix `which' command. OS specific dependencies are handled by the Java.lang.System properties.
	 * 
	 * @param executable
	 *            The executable to search for.
	 * @param pathEnv
	 *            The list of paths in which to search, in the style of the OS's PATH environment variable.
	 * @return The full pathname of where the executable lives, or failing that the error message "<executable> not found.".
	 */
