...
// package montecarlo;
/**
 * Base class for all the security objects, namely in terms of providing a consistent means of identifying each such object. Also provides some methods for writing out debug messages.
 * 
 * @author H W Yau
...
public class PathId extends Universal {
	 ...
	 * @exception DemoException
	 *                thrown if instance variable <code>startDate</code> is undefined.
	 */
	 ...
	 * @exception DemoException
	 *                thrown if the values to be copied contain any undefined objects.
	 */
