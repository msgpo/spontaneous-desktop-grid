...
public class MonteCarloPath extends PathId {
	...
	/**
	 * Class variable for determining which field in the stock data should be used. This is currently set to point to the 'closing price', as defined in class RatePath.
	 */
	...
	/**
	 * Integer flag for determining how the return was calculated, when used to calculate the mean drift and volatility parameters.
	 */
	...
	// ------------------------------------------------------------------------
	/**
	 * Default constructor. Needed by the HPT library to start create new instances of this class. The instance variables for this should then be initialised with the <code>setInitAllTasks()</code>
	 * method.
	 */
	...
	/**
	 * Constructor, using the <code>ReturnPath</code> object to initialise the necessary instance variables.
	 * 
	 * @param returnPath
	 ...
	 *                Thrown if there is a problem initialising the object's instance variables.
	 */
	...
	/**
	 * Constructor, where the <code>PathId</code> objects is used to ease the number of instance variables to pass in.
	 * 
	 * @param pathId
	...
	public MonteCarloPath(PathId pathId, int returnDefinition, double expectedReturnRate, double volatility, int nTimeSteps) throws DemoException {
		/**
		 * These instance variables are members of PathId class. Invoking with this particular signature should point to the definition in the PathId class.
		 */
	 ...
	 * @exception DemoException
	 *                thrown if instance variable <code>fluctuations</code> is undefined.
	 */
	 ...
	 * 
	 * @param fluctuations
	 *            the value to set for the instance variable <code>fluctuations</code>.
	 */
	 ...
	 * @exception DemoException
	 *                thrown if instance variable <code>nTimeSteps</code> is undefined.
	 */
	 ...
	 * @exception DemoException
	 *                thrown if instance variable <code>pathStartValue</code> is undefined.
	 */
	...
	/**
	 * Method for writing out the values from a Monte Carlo path into a data file. This can then be fed back in as a test. The data are written in the following format:
	 * 
	 * <pre>
	...
	/**
	 * Method for calculating the sequence of fluctuations, based around a Gaussian distribution of given mean and variance, as defined in this class' instance variables. Mapping from Gaussian
	 * distribution of (0,1) to (mean-drift,volatility) is done via Ito's lemma on the log of the stock price.
	 * 
	 * @param randomSeed
	 *            The psuedo-random number seed value, to start off a given sequence of Gaussian fluctuations.
	 * @exception DemoException
	...
	/**
	 * Method for calculating the sequence of fluctuations, based around a Gaussian distribution of given mean and variance, as defined in this class' instance variables. Mapping from Gaussian
	 * distribution of (0,1) to (mean-drift,volatility) is done via Ito's lemma on the log of the stock price. This overloaded method is for when the random seed should be decided by the system.
	 * 
	 * @exception DemoException
	 *                thrown if there are any problems with the computation.
	 */
	...
	/**
	 * Method for calculating the corresponding rate path, given the fluctuations and starting rate value.
	 * 
	 * @param startValue
	 *            the starting value of the rate path, to be updated with the precomputed fluctuations.
	 * @exception DemoException
	 *                thrown if there are any problems with the computation.
	 */
