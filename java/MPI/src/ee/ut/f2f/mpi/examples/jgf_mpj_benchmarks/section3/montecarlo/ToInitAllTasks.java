...
public class ToInitAllTasks implements java.io.Serializable {
	 ...
	 * @param name
	 *            The name of the security which this Monte Carlo path should represent.
	 * @param startDate
	 *            The date when the path starts, in 'YYYYMMDD' format.
	 * @param endDate
	 *            The date when the path ends, in 'YYYYMMDD' format.
	 * @param dTime
	 *            The interval in the data between successive data points in the generated path.
	 * @param returnDefinition
	 *            How the statistic variables were defined, according to the definitions in <code>ReturnPath</code>'s two class variables <code>COMPOUNDED</code> and <code>NONCOMPOUNDED</code>.
	 ...
	 *            The stock price value to use at the start of each Monte Carlo simulation path.
	 */
	...
	/**
	 * Another constructor, slightly easier to use by having slightly fewer arguments. Makes use of the "ReturnPath" object to accomplish this.
	 * 
	 * @param obj
	 *            Object used to define the instance variables which should be carried over to this object.
	 * @param nTimeSteps
	 *            The number of time steps which the Monte Carlo generator should make.
	 * @param pathStartValue
	 *            The stock price value to use at the start of each Monte Carlo simulation path.
	 * @exception DemoException
	 *                thrown if there is a problem accessing the instance variables from the target objetct.
	 */
	 ...
	 * 
	 * @param pathStartValue
	 *            the value to set for the instance variable <code>pathStartValue</code>.
	 */
