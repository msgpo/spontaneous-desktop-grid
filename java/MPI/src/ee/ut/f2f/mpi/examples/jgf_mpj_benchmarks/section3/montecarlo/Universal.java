...
/**
 * Base class for all non-trivial classes. Used as a centralised repository for all the functionalities which all classes written by me, which will be of use.
 * 
 * @author H W Yau
 */
public class Universal {
	...
	// ------------------------------------------------------------------------
	/**
	 * Class variable, for whether to print debug messages. This one is unique to this class, and can hence be set in the one place.
	 */
	...
	// ------------------------------------------------------------------------
	/**
	 * Variable, for whether to print debug messages. This one can be set by subsequent child classes.
	 */
	...
	public boolean get_UNIVERSAL_DEBUG() {
		return (Universal.UNIVERSAL_DEBUG);
	}
	 ...
	 *            the value to set for the instance variable <code>UNIVERSAL_DEBUG</code>.
	 */
