...
{	
	...
	// other private static final int MAX_MSG_LENGTH = 256 - F2F_TAG_START.length() - F2F_TAG_END.length(); // max size of MSN message is 1050 bytes
	private static final int SLEEP_TIME = 100; // How long to wait between sending messages
	// other private static final int SLEEP_TIME = 500; // How long to wait between sending messages
