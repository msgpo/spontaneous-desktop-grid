package net.ulno.jpunch.util.logging;
 ...
 *
 * @author Emil Ivov, Oleg Batrashev
 */
public class Logger
{
    ...
    {
        if (loggerDelegate.isLoggable(java.util.logging.Level.FINEST)) {
            StackTraceElement caller = new Throwable().getStackTrace()[1];
            loggerDelegate.log(java.util.logging.Level.FINEST, "[entry] " + caller.getMethodName());
        }
    }
    ...
    public void logExit()
    {
        if (loggerDelegate.isLoggable(java.util.logging.Level.FINEST)) {
            StackTraceElement caller = new Throwable().getStackTrace()[1];
            loggerDelegate.log(java.util.logging.Level.FINEST, "[exit] " + caller.getMethodName());
        }
    }
    ...
    {
        return loggerDelegate.isLoggable(java.util.logging.Level.FINER);
    }
    ...
    {
        loggerDelegate.log(java.util.logging.Level.FINER, msg!=null?msg.toString():"null", t);
    }
    ...
    {
        return loggerDelegate.isLoggable(java.util.logging.Level.FINE);
    }
    ...
    {
        loggerDelegate.log(java.util.logging.Level.FINE, msg!=null?msg.toString():"null", t);
    }
    ...
    {
        return loggerDelegate.isLoggable(java.util.logging.Level.INFO);
    }
    ...
    {
        loggerDelegate.log(java.util.logging.Level.INFO, msg!=null?msg.toString():"null", t);
    }
    ...
    {
        loggerDelegate.log(java.util.logging.Level.WARNING, msg!=null?msg.toString():"null", t);
    }
    ...
    {
        loggerDelegate.log(java.util.logging.Level.SEVERE, msg!=null?msg.toString():"null", t);
    }
    ...
    public void setLevel(Level level) {
    	setLevel((java.util.logging.Level) level.mapping);
    }
	...
	static void initializeMapping() {
		Level.TRACE.mapping = java.util.logging.Level.FINER;
		Level.DEBUG.mapping = java.util.logging.Level.FINE;
		Level.INFO.mapping = java.util.logging.Level.INFO;
		Level.WARN.mapping = java.util.logging.Level.WARNING;
		Level.ERROR.mapping = java.util.logging.Level.SEVERE;
		Level.FATAL.mapping = java.util.logging.Level.SEVERE;
	}
}
